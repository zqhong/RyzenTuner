...
namespace RyzenTuner.UI
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            {
                if (currentProc.ProcessName.IndexOf("WindowsFormsDesigner", System.StringComparison.OrdinalIgnoreCase) >= 0 ||
                    currentProc.ProcessName.IndexOf("devenv", System.StringComparison.OrdinalIgnoreCase) >= 0 ||
            ...
            this.radioPowerSave = new RadioButton();
            this.radioBalanced = new RadioButton();
            this.radioPerformance = new RadioButton();
            ...
            // 动态字体设置
            string[] tryFonts = { "微软雅黑", "思源黑体", "Arial" };
            foreach (string loopFont in tryFonts)
            {
            ...
            int navButtonHeight = 36;
            int[] navButtonY = { 72, 72 + navButtonHeight + 4, 72 + (navButtonHeight + 4) * 2, 72 + (navButtonHeight + 4) * 3, 72 + (navButtonHeight + 4) * 4 };
            string[] navButtonNames = { "navHome", "navSettings", "navBenchmark", "navLogs", "navAbout" };
            string[] navButtonTexts = { Properties.Strings.TextNavHome, Properties.Strings.TextNavSettings, Properties.Strings.TextNavBenchmark, Properties.Strings.TextNavLogs, Properties.Strings.TextNavAbout };
            Button[] navButtons = { this.navHome, this.navSettings, this.navBenchmark, this.navLogs, this.navAbout };
            ...
            for (int i = 0; i < navButtons.Length; i++)
            {
                ...
                btn.Location = new Point(12, navButtonY[i]);
                btn.Name = navButtonNames[i];
                btn.Size = new Size(176, navButtonHeight);
                btn.TabIndex = i + 1;
                btn.Text = navButtonTexts[i];
            ...
            this.groupBoxMode.Controls.Add(this.radioPowerSave);
            this.groupBoxMode.Controls.Add(this.radioBalanced);
            this.groupBoxMode.Controls.Add(this.radioPerformance);
            ...
            this.radioPowerSave.AutoSize = true;
            this.radioPowerSave.Location = new Point(24, 28);
            this.radioPowerSave.Name = "radioPowerSave";
            this.radioPowerSave.Text = Properties.Strings.PowerSaveMode;
            this.radioPowerSave.Tag = "PowerSaveMode";
            this.radioPowerSave.CheckedChanged += new EventHandler(this.ChangeEnergyMode);

            this.radioBalanced.AutoSize = true;
            this.radioBalanced.Location = new Point(224, 28);
            this.radioBalanced.Name = "radioBalanced";
            this.radioBalanced.Text = Properties.Strings.BalancedMode;
            this.radioBalanced.Tag = "BalancedMode";
            this.radioBalanced.CheckedChanged += new EventHandler(this.ChangeEnergyMode);

            this.radioPerformance.AutoSize = true;
            this.radioPerformance.Checked = true;
            this.radioPerformance.Location = new Point(425, 28);
            this.radioPerformance.Name = "radioPerformance";
            this.radioPerformance.Text = Properties.Strings.PerformanceMode;
            this.radioPerformance.Tag = "PerformanceMode";
            this.radioPerformance.CheckedChanged += new EventHandler(this.ChangeEnergyMode);
            ...
            this.Text = assemblyVersion != null
                ? $"RyzenTuner {assemblyVersion.Major}.{assemblyVersion.Minor}.{assemblyVersion.Build}"
                : "RyzenTuner";
            ...
            // EndInit for all ISupportInitialize controls (must precede ResumeLayout)
            ...
            ((System.ComponentModel.ISupportInitialize)(this.numericUpDownLogSaveDays)).EndInit();
        ...
        private RadioButton radioPowerSave;
