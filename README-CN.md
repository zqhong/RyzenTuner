...
* 待机模式（SleepMode）：处于最低功耗状态，只适合非常轻度的负载
* 平衡模式（BalancedMode）：在性能和能效之间提供更好的平衡，适合应对打开网页、使用 Photoshop 等短时任务
* 性能模式（PerformanceMode）：适用于编译软件、运行大型游戏、渲染等需要高性能的场景
...
如果你喜欢这个项目，或正在使用它，欢迎点一个 star 支持一下。你的支持也是作者持续维护和解答问题的动力！
